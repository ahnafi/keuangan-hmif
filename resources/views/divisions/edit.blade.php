...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <div class="mt-2">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Divisi</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">Perbarui informasi divisi</p>
        </div>
    </div>
