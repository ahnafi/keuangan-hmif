        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700">
                ...
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Perbarui informasi dana.
                </p>
            </div>

            <!-- Form -->
            <form method="POST" action="{{ route('fund.update', $fund) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-3 py-2 border rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-300 "
