                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    Tambah Pengurus, edit dan lainnya.
                                </p>
                            </div>
                                ...
                                @forelse($administrators as $administrator)
                                    <tr>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 py-3">
                                                <span class="text-sm text-gray-800 dark:text-neutral-200">{{ $administrator->id }}</span>
                                            </div>
                                        </td>
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $administrator->name }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm text-gray-800 dark:text-neutral-200">{{ $administrator->division->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500 dark:text-neutral-500">{{ $administrator->created_at->format('d M Y, H:i') }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5 flex gap-x-2">
                                                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500"
                                                    href="{{ route('administrator.show', $administrator) }}">
                                                    Lihat
                                                </a>
                                                <a class="inline-flex items-center gap-x-1 text-sm text-green-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-green-500"
                                                    href="{{ route('administrator.edit', $administrator) }}">
                                                    Edit
                                                </a>
                                                <form method="POST" action="{{ route('administrator.destroy', $administrator) }}" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-12 text-center">
                                            <p class="text-gray-500 dark:text-neutral-500">Tidak ada administrator ditemukan.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $administrators->total() }}</span> hasil
                                </p>
                            </div>
